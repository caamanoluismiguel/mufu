...
try{
  ...
  await page.addStyleTag({content:'.print-actions,.museum-header,.reading-progress{display:none!important}.infographic{padding:50px 65px!important;background:#e4e6e1}'});
