...
export function visualEdition($,page,icon){
  ...
  const glosa={'index.html':'las diez semanas, parada por parada',
    'atlas.html':'lo que conecta los ocho módulos',
    'coleccion.html':'el registro completo, con su fotografía',
    'infografias.html':'dos láminas para mirar o imprimir',
    'archivo.html':'de dónde sale cada dato y qué no se sabe',
    'index.html#visita':'dónde está y qué se ve al llegar'};
  const links=destinations.map(([href,label])=>[href,label,glosa[href]||'']);
