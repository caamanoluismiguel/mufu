...
fs.writeFileSync('archive/edition-manifest.json',JSON.stringify({edition:'2026-09-09',note:'Huellas de esta edición. No certifican la verdad del contenido.',files:manifest},null,2)+'\n');
