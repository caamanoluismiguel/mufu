...
export const modules = [
  ...
  { id:'03', title:'Objetos que narran', teacher:'Luis Miguel Caamaño', lesson:'Los objetos hacen avanzar una historia.', from:'Pieza', to:'Signo legible', question:'¿Cómo diseñamos un mensaje para alguien sin nuestro contexto?', icon:'clapperboard', image:'img/martha-pretto-02.jpg', text:'Matrix y el camino del héroe abrieron tres funciones: MacGuffin, reliquia y talismán. El Disco de Oro llevó el problema al límite: comunicarse con alguien que no comparte idioma, cuerpo ni época.', threads:['memoria','imagen','tiempo'] },
  { id:'04', title:'Un museo especulativo para Panamá', teacher:'Karla Paniagua', lesson:'Todo objeto supone un mundo.', from:'Señales del presente', to:'Dos futuros posibles', question:'¿Quién tendrá la llave de la memoria?', icon:'git-branch', image:'img/roberto-torres-02.jpg', text:'Dos grupos rastrearon señales hasta sus fuentes y construyeron escenarios de transformación y colapso. En ambos, los originales dejan de verse y el público depende de reconstrucciones.', threads:['poder','imagen','tiempo'] },
...
export const nodes = [
  ...
  { id:'narrar', title:'El objeto narrativo', date:'03 · Puente', icon:'clapperboard', threads:['memoria','imagen','tiempo'], text:'En Matrix y el camino del héroe, los objetos activan acciones y transformaciones. MacGuffin: mueve la trama. Reliquia: conserva un pasado. Talismán: concentra un poder atribuido.', sources:['curso'] },
  { id:'leia', title:'El mensaje de Leia', date:'1976 → 1977 · Técnica e imaginario', icon:'message-circle', threads:['memoria','imagen','tiempo'], text:'Según American Cinematographer, Logan’s Run (1976) llevó holografía real a la pantalla y Michael York fue la primera estrella de cine que actuó en un holograma. Es lo que sostuvo la prensa del ramo en 1976, no una verificación independiente. Star Wars (1977) popularizó el holograma como imagen de la comunicación del futuro: R2-D2 hace presente a Leia y su mensaje activa el viaje de Luke. MUFU enlaza ese imaginario con la técnica teatral de Pepper.', sources:['logan','leia','leia-futuro','hilo'] },
  ...
  { id:'pared', title:'La pared', date:'2026 · Cierre', icon:'brick-wall', threads:['poder','tiempo','imagen'], text:'La solicitud para enterrar las cajas en el campus se envió y sigue sin respuesta, según el relato del proyecto. Se construyó un vacío bajo la escalera mientras tanto. Un silencio institucional terminó definiendo la forma del museo.', sources:['cierre','hilo','conteo'] },
...
export const custody = [
  ...
  { title:'Envasar y guardar', status:'Relato del proyecto', text:'El relato describe bolsas selladas por succión, etiquetas y dos cajas de acero inoxidable selladas, cada una con la mitad de los objetos. No se repartieron por autor ni por tema: se repartieron para que un fallo en una caja no se lleve la colección entera. El archivo público no identifica qué objeto va en cada una.', source:'cierre' },
