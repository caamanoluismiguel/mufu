...
export const sources = [
  ...
  { id: 'logan', title: 'American Cinematographer · Logan’s Run and How It Was Filmed', type: 'Fuente histórica / producción cinematográfica', url: 'https://theasc.com/article/logans-run-and-how-it-was-filmed/', note: 'Reportaje de producción de 1976 que documenta hologramas realizados para Logan’s Run. Es un antecedente cinematográfico anterior a Star Wars (1977).' },
...
export const nodes = [
  ...
  { id:'leia', title:'El mensaje de Leia', date:'1977 · Ficción', icon:'message-circle', threads:['memoria','imagen','tiempo'], text:'R2-D2 hace presente a una persona ausente y su mensaje activa el viaje de Luke. MUFU lee esta imagen emblemática de Star Wars como un referente cultural de la comunicación del futuro: una figura luminosa que habla a través de la distancia. Su importancia aquí es cultural; Logan’s Run ya utilizó hologramas en 1976.', sources:['leia','logan','hilo'] },
...
export const edges = [
  ...
  ['pepper','leia','imagen','Del efecto escénico patentado al holograma como imagen cultural del futuro: MUFU conecta una técnica del pasado con el imaginario de Star Wars.'],
