...
export const nodes = [
  ...
  { id:'leia', title:'El mensaje de Leia', date:'1977 · Ficción', icon:'message-circle', threads:['memoria','imagen'], text:'Un mensaje de una persona ausente, confiado a R2-D2, activa el viaje de Luke. Es un holograma dentro de la ficción de Star Wars, no el primer holograma de la historia.', sources:['leia'] },
  ...
  { id:'pepper', title:'El fantasma de Pepper', date:'1862 · Óptica', icon:'lightbulb', threads:['imagen','poder','tiempo'], text:'El reflejo en un vidrio inclinado hace aparecer una imagen sin materia en la escena. Una lámpara funciona como una llave de la visibilidad.', sources:['pepper','curso'] },
...
export const edges = [
  ...
  ['pepper','leia','imagen','Presencia luminosa de un ausente; técnicas distintas.'],
